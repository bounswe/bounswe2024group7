...
const PostCard = ({ title, description, owner, date, likeCount, commentCount, navigation }) => {
  return (
    <TouchableOpacity
              style={styles.card}
              onPress={() => navigation.navigate('PostDetail', { title, description, owner, date, likeCount, commentCount, navigation })}
            >
      {/* Post Image */}
      <Image
